...
public class CommandListPlayers extends CommandBase
{
    ...
    public void processCommand(CommandSender sender, String[] args) throws CommandException
    {
        ...
        sender.sendMessage(new ChatComponentTranslation("commands.players.list", new Object[] {Integer.valueOf(i), Integer.valueOf(MinecraftServer.getServer().getMaxPlayers())}));
